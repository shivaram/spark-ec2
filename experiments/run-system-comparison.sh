#!/bin/bash
EXPERIMENTS="binarytimit amazon"
NON_EXACT_SOLVERS="vw systemml block lbfgs"
...
do
  ...
  do
    ...
    do
      ...
      less $LOG_FILE | grep -i 'Finished System Conversion And Transfer' || true
